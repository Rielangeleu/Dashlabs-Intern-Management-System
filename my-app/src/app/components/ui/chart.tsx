...
// Using 'type' and 'Omit' to prevent the HTML vs Recharts 'content' property collision,
// and explicitly declaring Recharts props to bypass generic type failures.
...
type ChartLegendContentProps = Omit<React.ComponentProps<"div">, "content"> & {
  payload?: any[];
...
// Helper to extract item config from a payload safely typing around 'unknown'
